...
#Entries and StringVar
ent_str = tk.StringVar()
ent_str.set("Something...")
entry = tk.Entry(width=50, textvariable=ent_str)
#Append some text to the end
